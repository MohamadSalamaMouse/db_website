...
<div class="box-seat box-seat-full ">
    <div class="container-fluid">
        <div class="inner-img" data-dsn-grid="moveUp">
            ...
            <img data-dsn-scale="1" data-dsn-y="30%" src="{{Storage::url(Utility::getsettings('slider_image_section1'))}}"  alt="" style="transform: translate(0%, 8.62267%) translate3d(0px, 0px, 0px) scale(1.21377, 1.21377);">
        </div>
        <div class="pro-text">
            <h3> STAY <br>
                CONNECTED</h3>
